    ...
    <div className="absolute_wrap">
        ...
        <div className="absolute_wrap_header">
            <div className="circle hover1">
                <i className="arrow_back_icon" onClick={()=> {
                    setVisible(0)
                }}></i>
            </div>
        ...
        <div className="mmenu_main">
            <div className="small_circle" style={{width: "70px"}}>
        ...
        <div className="mmenu_main">
            ...
            <div className="mmenu_col">
                ...
                <span className="mmenu_span2">Make your font size smaller so more content can fit on your screen</span>
            </div>
        </div>
